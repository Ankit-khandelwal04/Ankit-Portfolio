      ...
      <div className="z-10">
        ...
        <div className="text-[#ADB7BE] space-y-4">
          ...
          <div className="flex items-center gap-3 hover:scale-105 transition-transform duration-200 cursor-pointer">
            ...
            <a href="tel:+919767572670" className="hover:underline">
              +91-9767572670
            </a>
          </div>
        </div>

        <div className="socials flex flex-row gap-2 py-5">
          <Link href="https://github.com/Ankit-khandelwal04" className="flex hover:scale-115 transition-transform duration-200 cursor-pointer">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/ankit-khandelwal-002474295/" className="flex hover:scale-115 transition-transform duration-200 cursor-pointer">
